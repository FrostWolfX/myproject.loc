                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input class="input" type="password" name="passwordOld" id="password"
                                               placeholder="password" value="<?= $_POST['passwordOld'] ?? '' ?>">
                                        <br><br>
                                        <label for="password">Новый password</label>
                                        <input class="input" type="password" name="passwordNew1" id="password"
                                               placeholder="password" value="<?= $_POST['passwordNew1'] ?? '' ?>">
                                        <br><br>
                                        <label for="password">Повторите новый password</label>
                                        <input class="input" type="password" name="passwordNew2" id="password"
